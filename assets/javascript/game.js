...
userHealth = attack=> userHp -= attack;

// function that calculates enemy health 
enemyHealth = attack=> enemyHp -= attack;

// function that displays character array to DOM
displayCharacters = (id, arr) =>{
    arr.forEach(char=>$(id).append("<div class='col-3 character' value="+char.value+"><div class='card text-center'><div class='card-header name'>"+char.name+"</div><div class='imgBox'><img src="+char.img+" class='img' alt="+char.name+"></div><div class='card-footer hp'>"+char.hp+"</div></div></div>"));        
}

// same as before but changes class of character to enemy
displayEnemies = (id, arr)=>{
    arr.forEach(char=>$(id).append("<div class='col-3 enemy' value="+char.value+"><div class='card text-center'><div class='card-header name'>"+char.name+"</div><div class='imgBox'><img src="+char.img+" class='img' alt="+char.name+"></div><div class='card-footer hp'>"+char.hp+"</div></div></div>"));     
}
